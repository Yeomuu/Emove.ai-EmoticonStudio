...
- Capture analysis samples distinct live video frames throughout the recording. Show measured temporal motion before static posture labels, track both horizontal and vertical repetition independently of hand-shape classes, and never describe proximity to the head as proven physical contact. Generation must preserve observed motion even without a named gesture.
